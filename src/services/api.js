...
export const fetchGoogleTranslate = option => {
  let url = `${option.host}/translate_a/single?client=at&dt=at&dt=bd&dt=ex&dt=ld&dt=md&dt=qca&dt=rw&dt=rm&dt=ss&dt=t&ie=UTF-8&oe=UTF-8&source=btn&rom=1&srcrom=1&ssel=0&tsel=0&kc=0`
...
export const fetchGoogleSound = option => {
  let url = `${option.host}/translate_tts?ie=UTF-8&total=1&idx=0&client=at&prev=input`
